...
function PlatformNavbar({ stores }: { stores: StoreWithProducts[] }) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-30 bg-white
      ...
      <nav className="mx-auto max-w-7xl px-6 lg:px-8 h-[56px] flex
                ...
                {menuOpen && (
                  <motion.div
                    ...
                    className="absolute right-0 top-full mt-2 w-52 bg-white
                      border border-neutral-100 shadow-lg z-50"
                  >
                    ...
                    <div className="border-t border-neutral-100 py-1">
                      <button
                        ...
                        className="w-full flex items-center px-4 py-2.5
                          text-xs text-neutral-400 hover:text-neutral-900
          ...
          >
            <ul className="flex flex-col gap-5">
              ...
              {state === "platform_admin" && (
                <>
                  <li>
                    <Link href="/platform" onClick={() => setMobileOpen(false)} className="text-sm uppercase tracking-widest text-neutral-700 hover:text-[#E8001D] transition-colors">
                      Platform Dashboard
                    </Link>
                  </li>
                  <li>
                    <Link href="/platform/requests" onClick={() => setMobileOpen(false)} className="text-sm uppercase tracking-widest text-neutral-700 hover:text-[#E8001D] transition-colors">
                      Store Requests
                    </Link>
                  </li>
                  <li>
                    <Link href="/platform/tenants" onClick={() => setMobileOpen(false)} className="text-sm uppercase tracking-widest text-neutral-700 hover:text-[#E8001D] transition-colors">
                      All Stores
                    </Link>
                  </li>
                </>
...
export function PlatformHomePage({ stores }: PlatformHomeProps) {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero */}
      <section className="pt-[56px] min-h-[58vh] flex items-center
        ...
        <div className="relative z-10 mx-auto max-w-7xl w-full px-6
          ...
          >
            <div className="flex flex-col gap-4">
              ...
              <h1 className="font-bebas text-[36px] sm:text-[56px]
                md:text-[108px] leading-none tracking-tight whitespace-nowrap">
                Every Shoe.<br />
                Every Store.
              </h1>
            ...
            <div className="flex items-center gap-4 flex-wrap">
              <a
                href="#shops"
                className="bg-white text-neutral-900 px-8 py-3.5 text-xs
                  uppercase tracking-widest border border-white
                  hover:bg-[#E8001D] hover:border-[#E8001D] hover:text-white
                  transition-colors"
              >
                Browse Stores
              </a>
              <Link
                href="/register-store"
                className="bg-transparent text-white px-8 py-3.5 text-xs
                  uppercase tracking-widest border border-white/40
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="flex flex-col gap-3 mb-12">
            ...
            <p className="text-sm text-neutral-500 max-w-lg">
              ShoePalace is Kenya&apos;s multi-vendor footwear marketplace.
              Each store is independently run, reviewed by our team, and
              powered by a shared platform so you always get a consistent
              experience.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            <div className="flex flex-col gap-6">
              <div className="flex flex-col gap-3">
                ...
                <p className="text-sm text-neutral-500 leading-relaxed">
                  Questions about the platform, your store application, or
                  anything else? We&apos;re a small team based in Nairobi
                ...
                {[
                  ...
                  <div key={item.label} className="flex flex-col gap-0.5">
                    ...
                    {item.href ? (
                      <a
                        href={item.href}
                        className="text-sm text-neutral-900 hover:text-[#E8001D]
                          transition-colors"
                      >
                        {item.value}
                      </a>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col gap-3">
                ...
                <p className="text-sm text-neutral-500 leading-relaxed">
                  Apply to join the platform. Applications are reviewed by
                  hand and we&apos;ll get back to you within 24 hours.
                </p>
              </div>
              <Link
                href="/register-store"
                className="inline-flex items-center gap-2 bg-neutral-900
                  text-white px-6 py-3 text-xs uppercase tracking-widest
                  hover:bg-[#E8001D] transition-colors w-fit"
              >
                Apply Now →
              </Link>
            </div>
