  ...
  const bg = (
    <>
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at center, transparent 40%, rgba(245,240,232,0.85) 100%)",
        }}
      />
    </>
  );
  ...
  if (success) {
    return (
      <div className="relative flex min-h-screen items-center justify-center bg-[#F5F0E8] px-6 overflow-hidden">
        {bg}
        <div className="relative z-10 w-full max-w-sm bg-white rounded-2xl shadow-xl shadow-neutral-200/60 p-10">
          <div className="w-8 h-0.5 bg-[#E8001D] mb-6" />
          <h1 className="font-bebas text-5xl leading-none text-neutral-900 mb-3">
            Check Your<br />Email
          </h1>
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-[#F5F0E8] px-6 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-sm bg-white rounded-2xl shadow-xl shadow-neutral-200/60 p-10">
        ...
        {serverError && (
          <div role="alert" className="border border-[#E8001D] bg-red-50
            px-4 py-3 text-sm text-[#E8001D] mb-6">
            {serverError}
          </div>
        )}
