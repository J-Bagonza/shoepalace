    ...
    <div className="flex min-h-screen items-center justify-center
      ...
      <div className="w-full max-w-sm bg-white p-10">
        ...
        <Link
          ...
          className="block text-center text-[10px] uppercase tracking-widest
            text-neutral-400 hover:text-neutral-900 transition-colors mt-6"
        >
          Forgot password?
        </Link>
        ...
        <div className="border-t border-neutral-100 mt-6 pt-5 text-center">
          <p className="text-xs text-neutral-400">
            ...
            <Link href="/register-store" className="text-neutral-700
